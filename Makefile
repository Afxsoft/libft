...
#    Updated: 2016/01/05 15:05:53 by aouloube         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME):
	@echo "\033[33;32m |*******************************| \033[33;0m"
	@echo "\033[33;32m |*            LIBFT            *| \033[33;0m"
	@echo "\033[33;32m |*******************************| \033[33;0m"
	@$(CC) $(CFLAGS) $(SRCS)
	@echo "\033[33;32m |*            GCC       OK [✓] *| \033[33;0m"
	@$(AR) $(NAME) $(OBJS)
	@echo "\033[33;32m |*            AR RC     OK [✓] *| \033[33;0m"
	@echo "\033[33;32m |*                             *| \033[33;0m"
	@echo "\033[33;32m |* =======  COMPLETED 😎  ===== *| \033[33;0m"
	@echo "\033[33;32m |*                             *| \033[33;0m"
	@echo "\033[33;32m |*******************************| \033[33;0m \n"
...
fclean: clean
	@echo "\033[33;32m |*******************************| \033[33;0m"
	@echo "\033[33;32m |*        LIBFT - CLEAN        *| \033[33;0m"
	@echo "\033[33;32m |*******************************| \033[33;0m"
	@$(RM) $(NAME)
	@echo "\033[33;32m |*                             *| \033[33;0m"
	@echo "\033[33;32m |* =======  ALL CLEAN 🚮  ===== *| \033[33;0m"
	@echo "\033[33;32m |*                             *| \033[33;0m"
	@echo "\033[33;32m |*******************************| \033[33;0m \n"
